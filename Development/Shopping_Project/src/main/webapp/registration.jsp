...
<script>
	function validateForm() {
		...
		var phoneno = document.forms["fruitkha-register"]["phoneno"].value;
...
<body>
			...
			<div class="row">
				<div class="col-lg-8 mb-5 mb-lg-0">
					<div class="form-title">
						...
						<p align="center">Fill in the form below to create your
							Fruitkha account.</p>
					</div>
					<div id="form_status"></div>
					<div class="registration-form">
						<form name="fruitkha-register" method="post"
							action="CustomerController" onsubmit="return validateForm();">
							<p>
								<input type="text" placeholder="First Name *" name="firstname"
									id="firstname" required> <input type="text"
							...
							<p>
								<input type="tel" placeholder="Phone" name="phoneno"
									id="phoneno" required> <input type="text"
				...
				<div class="col-lg-4">
					<div class="contact-form-wrap">
						<div class="contact-form-box">
							...
							<p>
								34/8, East Gandhinagar <br> Gujarat <br> India.
							</p>
						</div>
						<div class="contact-form-box">
							<h4>
	...
	<jsp:include page="footer.jsp" />
	 ...
	 <script>
        ...
        <% 
            String registrationFailed = (String) session.getAttribute("errorMessage");
