...
<body>
            ...
            <div class="row">
                <div class="col-lg-8 mb-5 mb-lg-0">
                    ...
                    <div class="registration-form">
                        ...
                        <form name="fruitkha-register" method="post" action="ForgotController" onsubmit="return validateForm();">
                            <p>
    ...
    <script>
        ...
        %>
            alert("<%= invalidEmail %>");
        <% 
            request.removeAttribute("invalidEmail"); // Remove the message after displaying it
            } 
        %>
        
        <% 
        	String SendOtpError = (String) request.getAttribute("SendOtpError");
        	if (SendOtpError != null) {
   		 %>
        	alert("<%= SendOtpError %>");
    	<% 
    		request.removeAttribute("SendOtpError"); // Remove the message after displaying it
        } 
   		 %>
    </script>
</body>
