...
<body>
	...
	if (session.getAttribute("otp") == null) {
		...
		Customer f = (Customer) session.getAttribute("UserData");
		email = f.getEmail();
	}
	%>
	<!-- PreLoader -->
				...
				<div class="col-lg-8 mb-5 mb-lg-0">
					...
					<div class="registration-form">
						...
						<form name="fruitkha-register" method="post"
							action="ForgotController" onsubmit="return validateForm();">
							<p>
								<input type="email" placeholder="Email *" name="email"
									id="email" required>
								<input type="password" placeholder="Enter New Password*" name="newpassword" id="password" required>
                                <i type="button" class="fas fa-eye toggle-password" onclick="togglePasswordVisibility()"></i>
                            
								<input type="password" placeholder="Enter Confirm Password *" name="Cpassword" id="password" required>
                                <i type="button" class="fas fa-eye toggle-password" onclick="togglePasswordVisibility()"></i>
