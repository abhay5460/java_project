...
// Use the DAO to get the category object
CategoryDAO dao = new CategoryDAO();
Category category = dao.getCategoryById(categoryId); // Fetch the category object
%>
<!DOCTYPE html>
			...
			<main class="h-full overflow-y-auto">
				<div class="container px-6 mx-auto grid my-6">
					<form action="../adminController" method="post">
						<input type="hidden" name="action" value="editCategory" /> <input
						...
						<div class="mb-4">
							...
							<textarea name="description" id="description" required
								class="mt-1 block w-full p-2 border border-gray-300 rounded-md dark:bg-gray-700 dark:text-gray-200"><%=category.getDescription()%></textarea>
						</div>
						<div class="mb-4">
							<label class="block text-gray-700 dark:text-gray-400"
								for="discountId">Discount ID</label> <input type="number"
								name="discountId" id="discountId"
								value="<%=category.getDiscountId()%>" required
								class="mt-1 block w-full p-2 border border-gray-300 rounded-md dark:bg-gray-700 dark:text-gray-200" />
						</div>
