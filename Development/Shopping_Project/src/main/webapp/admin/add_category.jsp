...
if (session2 == null || session2.getAttribute("admin_id") == null) {
	response.sendRedirect("admin/admin-index.jsp"); // Redirect to login page if not logged in
		...
		<div class="flex flex-col flex-1 w-full">
			<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
				<div
					...
					<h2
						class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">Add
						Category</h2>
			...
			<main class="h-full overflow-y-auto">
				<div class="container px-6 mx-auto grid my-6">
					<form action="../adminController" method="post">
						...
						<div class="mb-4">
							<label class="block text-gray-700 dark:text-gray-400"
								for="discountId">Discount ID</label> <input type="number"
								name="discountId" id="discountId" required
								class="mt-1 block w-full p-2 border border-gray-300 rounded-md dark:bg-gray-700 dark:text-gray-200" />
						</div>
						<div class="flex justify-end">
							<button type="submit"
								class="px-4 py-2 text-white bg-blue-600 rounded hover:bg-blue-700">Add
								Category</button>
						</div>
					</form>
				</div>
